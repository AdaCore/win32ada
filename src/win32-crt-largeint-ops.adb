...
--  Add many routine to fully support LARGE_INTEGER operations.
--  (ExtendedMagicDivide): removed, this was not the good place to define it
--   anyway.
--  (ExtendedLargeIntegerDivide): idem
--  (LargeIntegerDivide): idem
--  Fixes 8109-003.
