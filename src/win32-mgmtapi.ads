...
private
    ...
    pragma Import(Stdcall, SnmpMgrOpen, "SnmpMgrOpen");           -- mgmtapi.h:60
    pragma Import(Stdcall, SnmpMgrClose, "SnmpMgrClose");         -- mgmtapi.h:67
    pragma Import(Stdcall, SnmpMgrRequest, "SnmpMgrRequest");     -- mgmtapi.h:71
    pragma Import(Stdcall, SnmpMgrStrToOid, "SnmpMgrStrToOid");   -- mgmtapi.h:80
    pragma Import(Stdcall, SnmpMgrOidToStr, "SnmpMgrOidToStr");   -- mgmtapi.h:85
    pragma Import(Stdcall, SnmpMgrTrapListen, "SnmpMgrTrapListen");
                                                            -- mgmtapi.h:91
    pragma Import(Stdcall, SnmpMgrGetTrap, "SnmpMgrGetTrap");     -- mgmtapi.h:95
