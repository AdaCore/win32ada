...
package Win32.Scrnsave is
    ...
    szIniFile     : Win32.Winnt.TCHAR_Array(0..MAXFILELEN-1);
                                                            -- scrnsave.h:148
    szScreenSaver : Win32.Winnt.TCHAR_Array(0..21);         -- scrnsave.h:149
    szHelpFile    : Win32.Winnt.TCHAR_Array(0..MAXFILELEN-1);
                                                            -- scrnsave.h:150
    szNoHelpMemory: Win32.Winnt.TCHAR_Array(0..BUFFLEN-1);  -- scrnsave.h:151
...
private
    ...
    pragma Import(Stdcall, hMainInstance, "hMainInstance");       -- scrnsave.h:144
    pragma Import(Stdcall, hMainWindow, "hMainWindow");           -- scrnsave.h:145
    pragma Import(Stdcall, szName, "szName");                     -- scrnsave.h:146
    pragma Import(Stdcall, szAppName, "szAppName");               -- scrnsave.h:147
    pragma Import(Stdcall, szIniFile, "szIniFile");               -- scrnsave.h:148
    pragma Import(Stdcall, szScreenSaver, "szScreenSaver");       -- scrnsave.h:149
    pragma Import(Stdcall, szHelpFile, "szHelpFile");             -- scrnsave.h:150
    pragma Import(Stdcall, szNoHelpMemory, "szNoHelpMemory");     -- scrnsave.h:151
    pragma Import(Stdcall, MyHelpMessage, "MyHelpMessage");       -- scrnsave.h:152

    pragma Import(Stdcall, ScreenSaverProc, "ScreenSaverProc");   -- scrnsave.h:74
    pragma Import(Stdcall, DefScreenSaverProc, "DefScreenSaverProc"); 
                                                            -- scrnsave.h:107
    pragma Import(Stdcall, ScreenSaverConfigureDialog, "ScreenSaverConfigureDialog");
                                                            -- scrnsave.h:115
