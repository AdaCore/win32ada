...
package Win32.Winnetwk is
    ...
    function WNETADDCONNECTION3A(hwndOwner    : Win32.Windef.HWND;
                                 ...
                                 lpUserName   : Win32.LPCSTR;
                                 dwFlags      : Win32.DWORD)
        return Win32.DWORD;                                 -- winnetwk.h:216
    ...
    function WNETADDCONNECTION3W(hwndOwner    : Win32.Windef.HWND;
                                 ...
                                 lpUserName   : Win32.LPCWSTR;
                                 dwFlags      : Win32.DWORD)
        return Win32.DWORD;                                 -- winnetwk.h:224
    ...
    function WNETADDCONNECTION3 (hwndOwner    : Win32.Windef.HWND;
                                 ...
                                 lpUserName   : Win32.LPCSTR;
                                 dwFlags      : Win32.DWORD)
        return Win32.DWORD renames WNETADDCONNECTION3A;     -- winnetwk.h:234

    function WNETCANCELCONNECTIONA(lpName: Win32.LPCSTR;
                                   fForce: Win32.BOOL)
        return Win32.DWORD;                                 -- winnetwk.h:238

    function WNETCANCELCONNECTIONW(lpName: Win32.LPCWSTR;
                                   fForce: Win32.BOOL)
        return Win32.DWORD;                                 -- winnetwk.h:243
    ...
    function WNETCANCELCONNECTION2A(lpName : Win32.LPCSTR;
                                    dwFlags: Win32.DWORD;
                                    fForce : Win32.BOOL)
        return Win32.DWORD;                                 -- winnetwk.h:254

    function WNETCANCELCONNECTION2W(lpName : Win32.LPCWSTR;
                                    dwFlags: Win32.DWORD;
                                    fForce : Win32.BOOL)
        return Win32.DWORD;                                 -- winnetwk.h:260
    ...
    function WNETGETUNIVERSALNAMEA(lpLocalPath : Win32.LPCSTR;
        ...
        return Win32.DWORD;                                 -- winnetwk.h:291

    function WNETGETUNIVERSALNAMEW(lpLocalPath : Win32.LPCWSTR;
                                   dwInfoLevel : Win32.DWORD;
                                   lpBuffer    : Win32.LPVOID;
                                   lpBufferSize: Win32.LPDWORD)
        return Win32.DWORD;                                 -- winnetwk.h:298
    ...
    function WNETOPENENUMA(dwScope      : Win32.DWORD;
        ...
        return Win32.DWORD;                                 -- winnetwk.h:312
    ...
    function WNETOPENENUMW(dwScope      : Win32.DWORD;
                           ...
                           lpNetResource: access NETRESOURCEW;
                           lphEnum      : Win32.Windef.LPHANDLE)
        return Win32.DWORD;                                 -- winnetwk.h:320
    ...
    function WNETGETLASTERRORA(lpError      : Win32.LPDWORD;
        ...
        return Win32.DWORD;                                 -- winnetwk.h:401
    ...
    function WNETGETLASTERRORW(lpError      : Win32.LPDWORD;
                               ...
                               nNameBufSize : Win32.DWORD)
        return Win32.DWORD;                                 -- winnetwk.h:409
    ...
    function WNETGETLASTERROR (lpError      : Win32.LPDWORD;
                               ...
                               lpNameBuf    : Win32.LPSTR;
                               nNameBufSize : Win32.DWORD)
        return Win32.DWORD renames WNETGETLASTERRORA;       -- winnetwk.h:419

private

    pragma Convention(C_Pass_By_Copy, UNIVERSAL_NAME_INFOA);             -- winnetwk.h:98
    pragma Convention(C_Pass_By_Copy, UNIVERSAL_NAME_INFOW);             -- winnetwk.h:101
    pragma Convention(C_Pass_By_Copy, REMOTE_NAME_INFOA);                -- winnetwk.h:112
    pragma Convention(C_Pass_By_Copy, REMOTE_NAME_INFOW);                -- winnetwk.h:117
    pragma Convention(C, NETRESOURCEA);                     -- winnetwk.h:130
    pragma Convention(C, NETRESOURCEW);                     -- winnetwk.h:140
    ...
    pragma Import(Stdcall, WNETGETUNIVERSALNAMEW, "WNetGetUniversalNameW");
                                                            -- winnetwk.h:298
    pragma Import(Stdcall, WNETOPENENUMA, "WNetOpenEnumA");       -- winnetwk.h:312
    pragma Import(Stdcall, WNETOPENENUMW, "WNetOpenEnumW");       -- winnetwk.h:320
    pragma Import(Stdcall, WNETENUMRESOURCEA, "WNetEnumResourceA");
                                                            -- winnetwk.h:334
    pragma Import(Stdcall, WNETENUMRESOURCEW, "WNetEnumResourceW");
                                                            -- winnetwk.h:341
    pragma Import(Stdcall, WNETCLOSEENUM, "WNetCloseEnum");       -- winnetwk.h:354
    pragma Import(Stdcall, WNETGETUSERA, "WNetGetUserA");         -- winnetwk.h:363
    pragma Import(Stdcall, WNETGETUSERW, "WNetGetUserW");         -- winnetwk.h:369
