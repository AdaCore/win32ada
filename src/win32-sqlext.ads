...
private
    ...
    pragma Convention(C_Pass_By_Copy, DATE_STRUCT);                      -- sqlext.h:69
    pragma Convention(C_Pass_By_Copy, TIME_STRUCT);                      -- sqlext.h:76
    pragma Convention(C_Pass_By_Copy, TIMESTAMP_STRUCT);                 -- sqlext.h:83
