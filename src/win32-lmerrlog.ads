...
private
    ...
    pragma Import(Stdcall, NetErrorLogClear, "NetErrorLogClear"); -- lmerrlog.h:95
    pragma Import(Stdcall, NetErrorLogRead, "NetErrorLogRead");   -- lmerrlog.h:102
    pragma Import(Stdcall, NetErrorLogWrite, "NetErrorLogWrite"); -- lmerrlog.h:117
