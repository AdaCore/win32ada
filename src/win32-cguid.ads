...
private
    ...
    pragma Import(Stdcall, IID_IStubManager, "IID_IStubManager"); -- cguid.h:38
    ...
    pragma Import(Stdcall, IID_IInternalMoniker, "IID_IInternalMoniker");
                                                            -- cguid.h:42
    pragma Import(Stdcall, IID_IDfReserved1, "IID_IDfReserved1"); -- cguid.h:43
    pragma Import(Stdcall, IID_IDfReserved2, "IID_IDfReserved2"); -- cguid.h:44
    pragma Import(Stdcall, IID_IDfReserved3, "IID_IDfReserved3"); -- cguid.h:45
    pragma Import(Stdcall, CLSID_StdMarshal, "CLSID_StdMarshal"); -- cguid.h:46
    pragma Import(Stdcall, IID_IStub, "IID_IStub");               -- cguid.h:47
    pragma Import(Stdcall, IID_IProxy, "IID_IProxy");             -- cguid.h:48
    pragma Import(Stdcall, IID_IEnumGeneric, "IID_IEnumGeneric"); -- cguid.h:49
    pragma Import(Stdcall, IID_IEnumHolder, "IID_IEnumHolder");   -- cguid.h:50
    pragma Import(Stdcall, IID_IEnumCallback, "IID_IEnumCallback");
                                                            -- cguid.h:51
    pragma Import(Stdcall, IID_IOleManager, "IID_IOleManager");   -- cguid.h:52
    pragma Import(Stdcall, IID_IOlePresObj, "IID_IOlePresObj");   -- cguid.h:53
    pragma Import(Stdcall, IID_IDebug, "IID_IDebug");             -- cguid.h:54
    pragma Import(Stdcall, IID_IDebugStream, "IID_IDebugStream"); -- cguid.h:55
    ...
    pragma Import(Stdcall, CLSID_PSInPlaceFrame, "CLSID_PSInPlaceFrame");
                                                            -- cguid.h:60
    pragma Import(Stdcall, CLSID_PSDragDrop, "CLSID_PSDragDrop"); -- cguid.h:61
    pragma Import(Stdcall, CLSID_PSBindCtx, "CLSID_PSBindCtx");   -- cguid.h:62
    ...
    pragma Import(Stdcall, CLSID_StaticMetafile, "CLSID_StaticMetafile");
                                                            -- cguid.h:64
    pragma Import(Stdcall, CLSID_StaticDib, "CLSID_StaticDib");   -- cguid.h:65
    pragma Import(Stdcall, CID_CDfsVolume, "CID_CDfsVolume");     -- cguid.h:66
    ...
    pragma Import(Stdcall, CLSID_CCDComboBox, "CLSID_CCDComboBox");
                                                            -- cguid.h:85
    pragma Import(Stdcall, CLSID_CCDTextBox, "CLSID_CCDTextBox"); -- cguid.h:86
    pragma Import(Stdcall, CLSID_CCDCheckBox, "CLSID_CCDCheckBox");
                                                            -- cguid.h:87
    pragma Import(Stdcall, CLSID_CCDLabel, "CLSID_CCDLabel");     -- cguid.h:88
    pragma Import(Stdcall, CLSID_CCDOptionButton, "CLSID_CCDOptionButton");
                                                            -- cguid.h:89
    pragma Import(Stdcall, CLSID_CCDListBox, "CLSID_CCDListBox"); -- cguid.h:90
    ...
    pragma Import(Stdcall, CLSID_Picture_Metafile, "CLSID_Picture_Metafile");
                                                            -- cguid.h:121
    pragma Import(Stdcall, CLSID_Picture_EnhMetafile, "CLSID_Picture_EnhMetafile");
                                                            -- cguid.h:122
    pragma Import(Stdcall, CLSID_Picture_Dib, "CLSID_Picture_Dib");
                                                            -- cguid.h:123
    pragma Import(Stdcall, GUID_TRISTATE, "GUID_TRISTATE");       -- cguid.h:128
