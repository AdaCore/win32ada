...
package body Win32.Windowsx is
    ...
    function  CopyRgn(hrgnDst : Win32.Windef.HRGN;
                      hrgnSrc : Win32.Windef.HRGN) return Win32.INT is 
                                -- windowsx.h:49
        function To_HRGN is new Ada.Unchecked_Conversion(integer,
                Win32.Windef.HRGN);
    begin
   ...
   function SubclassWindow(hwnd : Win32.Windef.HWND;
    ...
    function HANDLE_WM_QUERYENDSESSION(hwnd  : Win32.Windef.HWND;
                                       ...
                                       return Win32.LRESULT is
                                                            -- windowsx.h:200
    begin
        return Win32.Winuser.MAKELRESULT(Win32.WORD(Win32.BOOL(fn(hwnd))), 0);
    ...
    procedure FORWARD_WM_SETREDRAW(hwnd   : Win32.Windef.HWND;
        ...
        garbage: Win32.LRESULT;
    begin
        garbage := fn(hwnd, Win32.Winuser.WM_SETREDRAW, Win32.WPARAM(fRedraw), 0);
    ...
    function FORWARD_WM_MDISETMENU(hwnd       : Win32.Windef.HWND;
                                   ...
                                   return Win32.Windef.HMENU is
                                                            -- windowsx.h:789
        function To_HMENU is new Ada.Unchecked_Conversion(UINT,
                Win32.Windef.HMENU);
...
--        function To_long is new Ada.Unchecked_Conversion(Win32.Windef.HMENU,
 --               Win32.LONG);
    ...
    function GET_WM_VSCROLL_MPS(code : Win32.WORD;
                                pos : Win32.WORD;
                                hwnd: Win32.Windef.HWND)
                                return Win32.LONG is        -- windowsx.h:1228
    begin
        return To_LONG(hwnd);
