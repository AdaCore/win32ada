...
package Win32.Winioctl is
    ...
    type MEDIA_TYPE is (                                    -- winioctl.h:201
    ...
    type BIN_TYPES is (                                     -- winioctl.h:436
...
private
    ...
    pragma Convention(C_Pass_By_Copy, SET_PARTITION_INFORMATION);        -- winioctl.h:293
    pragma Convention(C, DRIVE_LAYOUT_INFORMATION);         -- winioctl.h:302
    pragma Convention(C_Pass_By_Copy, VERIFY_INFORMATION);               -- winioctl.h:313
    pragma Convention(C_Pass_By_Copy, REASSIGN_BLOCKS);                  -- winioctl.h:323
    pragma Convention(C_Pass_By_Copy, PREVENT_MEDIA_REMOVAL);            -- winioctl.h:339
