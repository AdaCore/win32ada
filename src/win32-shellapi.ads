...
private
    ...
    pragma Import(Stdcall, DragAcceptFiles, "DragAcceptFiles");   -- shellapi.h:35
    ...
    pragma Import(Stdcall, FindExecutableA, "FindExecutableA");   -- shellapi.h:57
    pragma Import(Stdcall, FindExecutableW, "FindExecutableW");   -- shellapi.h:58
